 ...
 <!-- Header -->
        ...
        <div class="space-y-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center space-x-2 text-sm text-gray-500">
                    ...
                    <span id="pending-count"><?php echo $approved_count; ?> Approved applications</span>
                </div>
            </div>
            ...
            <div class="grid gap-6" id="user-cards-container">
                <?php
                $stmt = $conn->prepare("SELECT * FROM tutors WHERE status = 'Approved'");
                $stmt->execute();
                ...
                if (count($result) > 0) {
                    ...
                    echo "</svg>";
                    echo "<h3 class='mt-2 text-sm font-medium text-gray-900'>No approved tutors</h3>";
                    echo "<p class='mt-1 text-sm text-gray-500'>No tutors have been approved yet.</p>";
                    echo "</div>";
                }
    ...
    <script>
        function confirmAction(form) {
            return confirm("Are you sure you want to revoke approval for this tutor?");
        }
                ...
                <div class="relative">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-8 flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <form action="" method="post" onsubmit="return confirmAction(this)" class="inline">
                                <input type="hidden" name="id" value="${tutor.id}">
                                <button type="submit" name="reject" class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-danger rounded-lg hover:bg-red-600 transition-colors duration-200">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
                                    </svg>
                                    Reject
