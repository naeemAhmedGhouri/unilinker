...
if(isset($_POST['submit'])){
   ...
   header('location:contents.php?get_id='.$get_id);
   exit();
...
if(isset($_POST['delete'])){
   ...
   if ($fetch_thumb['thumb'] && $fetch_thumb['thumb'] != 'default_playlist.jpg' && file_exists($thumb_path)) {
       unlink($thumb_path);
   }
...
<section class="playlist-form">
   ...
   <h1 class="heading">update Folder</h1>
